...
def register_additions(data, elements, bill):
    subtotal = 0
    for id_name, name, price in elements:
        quantity = int( data[id_name] )
        print(id_name, quantity)
    return subtotal
